...
classesFile = "denn_labels.names"; #contains all the objects for which themodel wa trained. you have to generate yours
classes = None
with open(classesFile, 'rt') as f:
   classes = f.read().rstrip('\n').split('\n')
 
# Load the colors
colorsFile = "color.txt";
...
textGraph = "./mask_rcnn_inception.pbtxt";
